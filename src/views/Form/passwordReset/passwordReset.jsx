...
import { verifyToken, resetPasswordBack, setError } from "../../../redux/actions";
                            ...
                            <div>
                                ...
                                <div>
                                    ...
                                    <form onSubmit={(e) => handleSubmitResetPassword(e)}>
                                        ...
                                        <input type="password" value={password} onChange={(e) => validatePassword(e)} />
                                        {/* {errorPassword && <div style={{"color" : "red"}}>{errorPassword}</div>} */}

                                        <label style={{"color" : "white"}}>Confirm Password</label>
                                        <input type="password" value={confirmPassword} onChange={(e) => validateConfirmPassword(e)} />
